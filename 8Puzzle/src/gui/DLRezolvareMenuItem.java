...
public class DLRezolvareMenuItem extends JMenuItem implements Command {

	public JPanel mainPanel;
	public JFrame frame;
	
	public DLRezolvareMenuItem(JPanel p,JFrame f) {
		super("Cautare in Adancime Limitata!");
		this.mainPanel=p;
		this.frame=f;
	}
	...
	@Override
	public void execute() {
SolvingStrategy strategieRezolvare=new DL();
